<template>
    <PagesBreadcrumb name="Product Details" />
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="product-details-small-img">
                                            <img src="/assets/images/product-details/pro-details-small-img-1.png"
                                                alt="Product Thumnail">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="product-details-small-img">
                                            <img src="/assets/images/product-details/pro-details-small-img-2.png"
                                                alt="Product Thumnail">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="product-details-small-img">
                                            <img src="/assets/images/product-details/pro-details-small-img-3.png"
                                                alt="Product Thumnail">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="product-details-small-img">
                                            <img src="/assets/images/product-details/pro-details-small-img-4.png"
                                                alt="Product Thumnail">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="product-details-small-img">
                                            <img src="/assets/images/product-details/pro-details-small-img-5.png"
                                                alt="Product Thumnail">
                                        </div>
                                    </div>
                                </div>
                ...
                <div id="des-details1" class="tab-pane active">
                    <div class="product-description-content text-center">
                        <p data-aos="fade-up" data-aos-delay="200">Lorem ipsum dolor sit amet, consectetur adipisicing elit,
                            ...
                            nostrud exercita ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor
                        ...
                        <div class="product-wrap" data-aos="fade-up" data-aos-delay="200">
                            <div class="product-img img-zoom mb-25">
                                ...
                                <div class="product-action-2-wrap">
                                    <button class="product-action-btn-2" title="Add To Cart"><i class="pe-7s-cart"></i> Add
                                        to cart</button>
                                </div>
                            </div>
